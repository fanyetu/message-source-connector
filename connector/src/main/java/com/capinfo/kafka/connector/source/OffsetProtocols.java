...
public class OffsetProtocols {
    ...
    public static Map<String, String> sourcePartitionForProtocolV1(TableId tableId) {
        ...
        partitionForV1.put(MessageSourceConnectorConstants.TABLE_NAME_KEY, fqn);
        partitionForV1.put(
                MessageSourceConnectorConstants.OFFSET_PROTOCOL_VERSION_KEY,
                MessageSourceConnectorConstants.PROTOCOL_VERSION_ONE
        );
    ...
    public static Map<String, String> sourcePartitionForProtocolV0(TableId tableId) {
        return Collections.singletonMap(
                MessageSourceConnectorConstants.TABLE_NAME_KEY,
                tableId.tableName()
        );
    }
}
