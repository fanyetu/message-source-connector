...
import com.capinfo.kafka.connector.dialect.DatabaseDialectProvider.SubprotocolBasedProvider;
import com.capinfo.kafka.connector.util.ColumnId;
import com.capinfo.kafka.connector.util.ExpressionBuilder;
import com.capinfo.kafka.connector.util.ExpressionBuilder.Transform;
import com.capinfo.kafka.connector.util.IdentifierRules;
import com.capinfo.kafka.connector.util.TableId;
...
/**
 * A {@link com.capinfo.kafka.connector.dialect.DatabaseDialect} for MySQL.
 */
public class MySqlDatabaseDialect extends GenericDatabaseDialect {
    ...
    public static class Provider extends SubprotocolBasedProvider {
        ...
        @Override
        public com.capinfo.kafka.connector.dialect.DatabaseDialect create(AbstractConfig config) {
